...
class Forest(Model):
    ...
    def from_sklearn(cls, sk_model):
        ...
        if isinstance(sk_model, (BaggingClassifier, RandomForestClassifier, ExtraTreesClassifier, AdaBoostClassifier,
            ...
            if isinstance(sk_model, (AdaBoostClassifier)):
                ...
                model.weights = [sk_model.learning_rate for _ in range(
                    num_models * sk_model.n_classes_)]  # weights are equal to the learning rate for GradientBoosting
